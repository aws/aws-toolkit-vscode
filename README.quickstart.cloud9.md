...
| `AWS: Create new CloudFormation Template` | Creates a new boilerplate Cloudformation Template                                                                                                                                                                                          |
| `AWS: Create new SAM Template`            | Creates a new boilerplate SAM Template                                                                                                                                                                                                     |
