package software.aws.toolkits.jetbrains.ui.lambda
...
class LambdaViewerProvider() : FileEditorProvider {
    ...
    override fun createEditor(project: Project, file: VirtualFile): FileEditor = LambdaViewer(project, file as LambdaVirtualFile)
