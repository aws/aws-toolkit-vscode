...
export const noActiveQTransformConnectionMessage =
    'Amazon Q Code Transformation requires an active IAM Identity Center connection or an active AWS Builder ID connection. For more information, see the [Code Transformation documentation](LINK_HERE).'
