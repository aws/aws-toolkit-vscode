...
describe('DefaultAwsClientBuilderV3', function () {
    ...
    describe('createAndConfigureSdkClient', function () {
        ...
        //     const service = await builder.createAwsService(FakeEc2Client, {
        //         apiConfig: { operations: { FakeOperation: {} } },
        //         onRequestSetup: [
        //             (request: any) => {
        //                 assert.ok(request.service instanceof FakeEc2Client)
        ...
        //     const base = class extends FakeEc2Client {
        ...
        //         const instance = new FakeEc2Client(...args)
        ...
        //     assert.ok(service instanceof FakeEc2Client)
