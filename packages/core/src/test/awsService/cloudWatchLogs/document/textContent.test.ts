...
import {
    generateTextFromLogEvents,
    timestampSpaceEquivalent,
} from '../../../../awsService/cloudWatchLogs/document/textContent'
import { CloudWatchLogsEvent } from '../../../../awsService/cloudWatchLogs/registry/logDataRegistry'
