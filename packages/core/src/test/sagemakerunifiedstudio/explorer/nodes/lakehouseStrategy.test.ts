...
import { GlueCatalog as GlueCatalogClient } from '@amzn/glue-catalog-client'
...
describe('LakehouseStrategy', function () {
    ...
    beforeEach(function () {
        ...
        sandbox.stub(GlueCatalogClient.prototype, 'getCatalogs').callsFake(mockGlueCatalogClient.getCatalogs)
    ...
    describe('createLakehouseConnectionNode', function () {
        ...
        it('should create placeholder when no catalogs found', async function () {
            ...
            mockGlueCatalogClient.getCatalogs.resolves({ CatalogList: [], NextToken: undefined })
