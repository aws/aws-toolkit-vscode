        ...
        <body>
            ...
            <script type="text/javascript">
                ...
                const init = () => {
                    ...
                    qChat = amazonQChat.createChat(vscodeApi, {disclaimerAcknowledged: ${disclaimerAcknowledged}, pairProgrammingAcknowledged: ${pairProgrammingAcknowledged}, agenticMode: true, quickActionCommands: commands, modelSelectionEnabled: true}, hybridChatConnector, ${JSON.stringify(featureConfigData)});
                }
