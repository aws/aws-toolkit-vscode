...
class DynamicResourceCreateResourceAction(): SingleExplorerNodeAction<DynamicResourceResourceTypeNode>(message("dynamic_resources.create_resource")), DumbAware {
    ...
    override fun actionPerformed(selected: DynamicResourceResourceTypeNode, e: AnActionEvent) {
        ...
        DynamicResources.addResourceSchemaMapping(selected.nodeProject, file)
