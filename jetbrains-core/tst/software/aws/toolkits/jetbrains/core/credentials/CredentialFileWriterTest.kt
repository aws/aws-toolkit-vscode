...
internal class CredentialFileWriterTest {
    ...
    fun testDumpToFile() {
        ...
        assertThatThrownBy { CredentialFileWriter.dumpToFile(credentialsFile, false, BasicProfile("a",
                basicCred1
        )) }
    ...
    fun testRenameProfile() {
        ...
        CredentialFileWriter.modifyOneProfile(credentialsFile, "a", BasicProfile("A",
                basicCred1
        ))
        checkCredentialsFile(credentialsFile, *modified)
    }
