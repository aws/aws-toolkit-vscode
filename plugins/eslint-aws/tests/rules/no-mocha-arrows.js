...
var expectedErrorMessage = 'No arrow functions allowed!'
var errors = [{ message: expectedErrorMessage, column: 1, line: 1 }]
ruleTester.run('no-mocha-arrows', __1.rules['no-mocha-arrows'], {
    valid: [
        'it()',
