...
!(function(e, t) {
            ...
            t.data
                ? (function(e) {
                      ...
                      for (; i--; ) {
                          var o = n[i]
                          ;(r && y(r, o)) ||
                              ((a = void 0), 36 !== (a = (o + '').charCodeAt(0)) && 95 !== a && dn(e, '_data', o))
                      }
                      var a
                      Ce(t, !0)
                  })(e)
    ...
    function la(e, t) {
        ...
        return (
            (function(e, t) {
                for (
                    var n, r, i = [], o = t.expectHTML, a = t.isUnaryTag || T, s = t.canBeLeftOpenTag || T, c = 0;
                    e;
                ...
                for (t = 0, n = u.length; t < n; t++)
                    if (((r = i = u[t].name), (o = u[t].value), Go.test(r)))
                        if (((e.hasBindings = !0), (a = ha(r.replace(Go, ''))) && (r = r.replace(ra, '')), na.test(r)))
                            ...
                            ;(c = !1),
                                f &&
                                    ((r = r.slice(0, -(f.length + 1))), ea.test(f) && ((f = f.slice(1, -1)), (c = !0))),
