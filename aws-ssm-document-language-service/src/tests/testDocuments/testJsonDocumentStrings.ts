...
export const documentMissingAction = {
    text: `{
        "schemaVersion": "0.3",
        "mainSteps": [
            {
...
export const documentMissingActionValue = {
    text: `{
        "schemaVersion": "0.3",
        "mainSteps": [
            {
...
export const documentContainsSize2Cycle = {
    text: `{
        "schemaVersion": "0.3",
        "mainSteps": [
            {
...
export const documentContainsComplicateCycle = {
    text: `{
        "schemaVersion": "0.3",
        "mainSteps": [
            {
