...
export class DefaultPublishSSMDocumentWizardContext implements PublishSSMDocumentWizardContext {
    ...
    public createPublishPrompter(region: string): Prompter<PublishSSMDocumentAction> {
        ...
        return createPrompter(publishItems, {
            title: localize(
    ...
    public createRegionPrompter(): Prompter<string> {
        ...
        return createPrompter(partitionRegions.map(region => ({ label: region.name, detail: region.id })), {
            title: localize(
    ...
    public createDocumentTypePrompter(): Prompter<string> {
        ...
        return createPrompter(documentTypeItems, {
            title: localize('AWS.ssmDocument.publishWizard.documentType.title', 'Select document type'),
            buttonBinds: this.buttons,
        })
    }

    public createUpdateDocumentPrompter(region: string, documentType?: string): Prompter<string> {
        function showError() {
        ...
        return createPrompter(documentItems, {
            title: localize(
