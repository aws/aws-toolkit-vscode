...
//         const sessionIdBefore = componentLatencyTimer.sessionId
...
//         const sessionId = componentLatencyTimer.sessionId
//         const validRecs = RecommendationHandler.instance.isValidResponse()
//         const references = componentLatencyTimer.recommendations[0].references
