...
export class DefaultAWSStatusBar implements AWSStatusBar {
    ...
    public readonly credentialContext: vscode.StatusBarItem
    private readonly _awsContext: AwsContext

    public constructor(awsContext: AwsContext, context: vscode.ExtensionContext) {
        this._awsContext = awsContext

        this.credentialContext = ext.vscode.window.createStatusBarItem(ext.vscode.StatusBarAlignment.Right, 100)
