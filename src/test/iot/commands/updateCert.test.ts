    ...
    describe('deactivateCommand', function () {
        this.beforeEach(function () {
            ...
            node = new IotCertWithPoliciesNode(
                { id: certificateId, arn: 'arn', activeStatus: 'ACTIVE', creationDate: new awsToolkit.clock.Date() },
                parentNode,
                instance(iot)
            )
        })
    ...
    describe('activateCommand', function () {
        this.beforeEach(function () {
            ...
            node = new IotThingCertNode(
                { id: certificateId, arn: 'arn', activeStatus: 'INACTIVE', creationDate: new awsToolkit.clock.Date() },
                thingParentNode,
                instance(iot)
            )
        })
