...
//             const actual = componentLatencyTimer.recommendations
...
//             assert.strictEqual(componentLatencyTimer.sessionId, 'test_request')
...
//             componentLatencyTimer.startPos = new vscode.Position(1, 0)
...
//             const handler = new RecommendationHandler()
//             componentLatencyTimer.recommendations = [
//                 {
//                     content:
...
//             const handler = new RecommendationHandler()
//             componentLatencyTimer.recommendations = [{ content: '' }, { content: '' }]
//             assert.ok(!handler.isValidResponse())
//         })
//     })
...
//             componentLatencyTimer.setCompletionType(0, { content: 'test\n\n   \t\r\nanother test' })
//             assert.strictEqual(componentLatencyTimer.getCompletionType(0), 'Block')

//             componentLatencyTimer.setCompletionType(0, { content: 'test\ntest\n' })
//             assert.strictEqual(componentLatencyTimer.getCompletionType(0), 'Block')

//             componentLatencyTimer.setCompletionType(0, { content: '\n   \t\r\ntest\ntest' })
//             assert.strictEqual(componentLatencyTimer.getCompletionType(0), 'Block')
//         })

//         it('should set the completion type to line given a single-line suggestion', function () {
//             componentLatencyTimer.setCompletionType(0, { content: 'test' })
//             assert.strictEqual(componentLatencyTimer.getCompletionType(0), 'Line')

//             componentLatencyTimer.setCompletionType(0, { content: 'test\r\t   ' })
//             assert.strictEqual(componentLatencyTimer.getCompletionType(0), 'Line')
//         })
