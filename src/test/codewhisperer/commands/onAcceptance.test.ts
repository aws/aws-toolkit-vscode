...
describe('onAcceptance', function () {
    describe('onAcceptance', function () {
        ...
        //     sinon.stub(CWSessionManager, 'currentSession').returns(
        //         new CWSession(
        ...
        //     componentLatencyTimer.sessionId = 'test'
        ...
        //     componentLatencyTimer.recommendations = [{ content: "print('Hello World!')" }]
        //     componentLatencyTimer.setSuggestionState(0, 'Showed')
        //     TelemetryHelper.instance.triggerType = 'OnDemand'
        //     componentLatencyTimer.setCompletionType(0, componentLatencyTimer.recommendations[0])
