...
/**
 * @param additionalTestFiles - array of relative paths to test files that should be explicitly added to the test suite
 */
export function runTestsInFolder(testFolder: string, additionalTestFiles: string[] = []): Promise<void> {
    ...
    return new Promise((c, e) => {
        ...
        additionalTestFiles.forEach(relativePath => {
