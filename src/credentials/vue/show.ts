...
import { CredentialsData, CredentialsKey, SectionName, StaticCredentialsProfile } from '../types'
...
export class AuthWebview extends VueWebview {
    ...
    public getCredentialFormatError(key: CredentialsKey, value: string | undefined): string | undefined {
    ...
    async trySubmitCredentials(profileName: SectionName, data: StaticCredentialsProfile) {
