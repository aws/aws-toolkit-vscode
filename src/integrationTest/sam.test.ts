...
const scenarios: TestScenario[] = [
    ...
    {
        runtime: 'java8.al2',
        displayName: 'java8.al2 (Gradle ZIP)',
        path: 'HelloWorldFunction/src/main/java/helloworld/App.java',
        debugSessionType: 'java',
        language: 'java',
        dependencyManager: 'gradle',
    ...
    {
        runtime: 'java8',
        displayName: 'java8 (Gradle Image)',
        path: 'HelloWorldFunction/src/main/java/helloworld/App.java',
        baseImage: `amazon/java8-base`,
        debugSessionType: 'java',
        language: 'java',
    ...
    {
        runtime: 'java8.al2',
        displayName: 'java8.al2 (Maven Image)',
        path: 'HelloWorldFunction/src/main/java/helloworld/App.java',
    ...
    {
        runtime: 'java11',
        displayName: 'java11 (Gradle Image)',
        path: 'HelloWorldFunction/src/main/java/helloworld/App.java',
        baseImage: `amazon/java11-base`,
        debugSessionType: 'java',
        language: 'java',
