...
<!-- This Vue File provides Feedback page for CodeWhisperer-->
<template>
    <div>
        <div class="container button-container" style="justify-content: space-between">
            <h1>Feedback for CodeWhisperer</h1>
...
import { FeedbackCWWebview } from '../../../feedback/vue/submitFeedback'

const client = WebviewClientFactory.create<FeedbackCWWebview>()
