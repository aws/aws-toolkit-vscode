...
class DotNetSamProjectTemplate : SamAppTemplateBased() {
    ...
    override fun supportedZipRuntimes(): Set<LambdaRuntime> = setOf(LambdaRuntime.DOTNETCORE3_1)
    override fun supportedImageRuntimes(): Set<LambdaRuntime> = setOf(LambdaRuntime.DOTNETCORE3_1, LambdaRuntime.DOTNET5_0)
}
