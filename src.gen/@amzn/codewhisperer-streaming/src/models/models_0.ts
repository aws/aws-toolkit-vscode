 ...
 * @public
 */
export type CodeGenerationWorkflowStage = (typeof CodeGenerationWorkflowStage)[keyof typeof CodeGenerationWorkflowStage]
 ...
 * @public
 */
export type CodeGenerationWorkflowStatus =
    (typeof CodeGenerationWorkflowStatus)[keyof typeof CodeGenerationWorkflowStatus]

/**
 * @public
 */
export interface CodeGenStatus {
    status: CodeGenerationWorkflowStatus | string | undefined
    currentStage: CodeGenerationWorkflowStage | string | undefined
}
...
export const ChatResponseFilterSensitiveLog = (obj: ChatResponse): any => ({
    ...obj,
    ...(obj.chatResponse && { chatResponse: 'STREAMING_CONTENT' }),
})
 ...
 */
export interface ExecutePlanningInteractionRequest {
    /**
     * @public
     * Structure to represent the current state of a chat conversation.
     */
 ...
 * @internal
 */
export const ExecutePlanningInteractionRequestFilterSensitiveLog = (obj: ExecutePlanningInteractionRequest): any => ({
    ...obj,
    ...(obj.conversationState && { conversationState: ConversationStateFilterSensitiveLog(obj.conversationState) }),
})
 ...
 */
export interface ExecutePlanningInteractionResponse {
    /**
     * @public
     * Streaming events from UniDirectional Streaming Conversational APIs.
     */
 ...
 * @internal
 */
export const ExecutePlanningInteractionResponseFilterSensitiveLog = (obj: ExecutePlanningInteractionResponse): any => ({
    ...obj,
...
/**
 * @public
 * Request for getting code generation interaction result.
 */
export interface GetCodeGenerationInteractionResultRequest {
    /**
     * @public
...
/**
 * @public
 * Response for getting code generation interaction result.
 */
export interface GetCodeGenerationInteractionResultResponse {
    /**
     * @public
     * ID which represents a multi-turn conversation
     */
    ...
    codeGenStatus: CodeGenStatus | undefined
}
