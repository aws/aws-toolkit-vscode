 ...
 */
export const se_ChatCommand = async (input: ChatCommandInput, context: __SerdeContext): Promise<__HttpRequest> => {
...
/**
 * serializeAws_json1_0ExecutePlanningInteractionCommand
 */
export const se_ExecutePlanningInteractionCommand = async (
    input: ExecutePlanningInteractionCommandInput,
    context: __SerdeContext
): Promise<__HttpRequest> => {
    const headers: __HeaderBag = sharedHeaders('ExecutePlanningInteraction')
    let body: any
    body = JSON.stringify(se_ExecutePlanningInteractionRequest(input, context))
    return buildHttpRpcRequest(context, headers, '/', undefined, body)
}

/**
 * serializeAws_json1_0GetCodeGenerationInteractionResultCommand
 */
export const se_GetCodeGenerationInteractionResultCommand = async (
    input: GetCodeGenerationInteractionResultCommandInput,
    context: __SerdeContext
): Promise<__HttpRequest> => {
    const headers: __HeaderBag = sharedHeaders('GetCodeGenerationInteractionResult')
    let body: any
 ...
 */
const de_ChatCommandError = async (output: __HttpResponse, context: __SerdeContext): Promise<ChatCommandOutput> => {
...
/**
 * deserializeAws_json1_0ExecutePlanningInteractionCommand
 */
export const de_ExecutePlanningInteractionCommand = async (
    output: __HttpResponse,
    context: __SerdeContext & __EventStreamSerdeContext
): Promise<ExecutePlanningInteractionCommandOutput> => {
    if (output.statusCode >= 300) {
        return de_ExecutePlanningInteractionCommandError(output, context)
    }
    const contents = { planningResponseStream: de_ChatResponseStream(output.body, context) }
    const response: ExecutePlanningInteractionCommandOutput = {
        $metadata: deserializeMetadata(output),
        ...contents,
    }
    return response
...
/**
 * deserializeAws_json1_0ExecutePlanningInteractionCommandError
 */
const de_ExecutePlanningInteractionCommandError = async (
    output: __HttpResponse,
    context: __SerdeContext
): Promise<ExecutePlanningInteractionCommandOutput> => {
    const parsedOutput: any = {
...
/**
 * deserializeAws_json1_0GetCodeGenerationInteractionResultCommand
 */
export const de_GetCodeGenerationInteractionResultCommand = async (
    output: __HttpResponse,
    context: __SerdeContext
): Promise<GetCodeGenerationInteractionResultCommandOutput> => {
    if (output.statusCode >= 300) {
        return de_GetCodeGenerationInteractionResultCommandError(output, context)
    }
    const data: any = await parseBody(output.body, context)
    let contents: any = {}
    contents = _json(data)
    const response: GetCodeGenerationInteractionResultCommandOutput = {
        $metadata: deserializeMetadata(output),
        ...contents,
    }
    return response
...
/**
 * deserializeAws_json1_0GetCodeGenerationInteractionResultCommandError
 */
const de_GetCodeGenerationInteractionResultCommandError = async (
    output: __HttpResponse,
    context: __SerdeContext
): Promise<GetCodeGenerationInteractionResultCommandOutput> => {
    const parsedOutput: any = {
 ...
 */
const se_ChatRequest = (input: ChatRequest, context: __SerdeContext): any => {
    return take(input, {
...
/**
 * serializeAws_json1_0ExecutePlanningInteractionRequest
 */
const se_ExecutePlanningInteractionRequest = (
    input: ExecutePlanningInteractionRequest,
    context: __SerdeContext
): any => {
    return take(input, {
        conversationState: _json,
...
// se_GetCodeGenerationInteractionResultRequest omitted.

// de_AccessDeniedException omitted.

// de_AssistantResponseEvent omitted.

// de_CodeGenStatus omitted.
...
// de_GetCodeGenerationInteractionResultResponse omitted.
