...
import { GenerateTaskAssistPlanRequest, GenerateTaskAssistPlanResponse } from "../models/models_0";
 ...
 *
 */
export declare class GenerateTaskAssistPlanCommand extends $Command<GenerateTaskAssistPlanCommandInput, GenerateTaskAssistPlanCommandOutput, CodeWhispererStreamingClientResolvedConfig> {
    readonly input: GenerateTaskAssistPlanCommandInput;
    /**
     * @public
     */
    constructor(input: GenerateTaskAssistPlanCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CodeWhispererStreamingClientResolvedConfig, options?: __HttpHandlerOptions): Handler<GenerateTaskAssistPlanCommandInput, GenerateTaskAssistPlanCommandOutput>;
    /**
     * @internal
     */
    private serialize;
