...
import { QDeveloperStreamingHttpAuthSchemeProvider } from "./httpAuthSchemeProvider";
import {
...
export interface HttpAuthExtensionConfiguration {
  ...
  setHttpAuthSchemeProvider(httpAuthSchemeProvider: QDeveloperStreamingHttpAuthSchemeProvider): void;
